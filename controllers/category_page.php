    ...
    <div class="nav-scroller py-1 mb-3 border-bottom">
        ...
        <nav class="nav nav-underline justify-content-between">
            ...
            while($row=mysqli_fetch_array($query1)){
                ...
                ?>
                <a class="nav-item nav-link link-body-emphasis" href="/categorypage?single=<?php echo $row['category_name'];?>"><?php echo $row['category_name'];?></a>
            <?php } ?>
        </nav>
        ...
        <div class="row g-5">
            <div class="col-md-8">
                ...
                <article class="blog-post">
                    <h2 class="display-5 link-body-emphasis mb-1"><a href="/singlepage?single=
                <?php echo $row['id'];?>"><?php echo $row['title'];?></h2>
                    ...
                    <blockquote class="blockquote">
                        ...
                        <a href="/singlepage?single=<?php echo $row['id'];?>" class="btn btn-danger btn-sm">Read More...</a>
                    </blockquote>
                    <hr>
